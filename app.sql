...
--
-- Host: 127.0.0.1
-- Tempo de geração: 29-Set-2022 às 16:27
...
CREATE TABLE `ataques` (
  ...
  `nome_ataque` varchar(4) DEFAULT NULL,
...
INSERT INTO `ataques` (`id_ataques`, `nome_ataque`, `valor`) VALUES
(1, 'arma', NULL),
(2, 'tipo', NULL),
(3, 'ataq', NULL),
(4, 'alca', NULL),
...
CREATE TABLE `atributos` (
  ...
  `nome_atributo` varchar(40) DEFAULT NULL,
  `valor` int(2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `atributos` (`id_atributos`, `nome_atributo`, `valor`) VALUES
(1, 'agilidade', NULL),
(2, 'intelecto', NULL),
(3, 'vigor', NULL),
(4, 'presença', NULL),
...
CREATE TABLE `defesas` (
  ...
  `nome_defesa` varchar(40) DEFAULT NULL,
  `valor` int(2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `defesas` (`id_defesas`, `nome_defesa`, `valor`) VALUES
(1, 'passiva', NULL),
(2, 'bloqueio', NULL),
(3, 'esquiva', NULL);
...
CREATE TABLE `resistencias_a_dano` (
  ...
  `nome_resistencia` varchar(40) DEFAULT NULL,
  `valor` int(2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Extraindo dados da tabela `resistencias_a_dano`
--

INSERT INTO `resistencias_a_dano` (`id_resistencias`, `nome_resistencia`, `valor`) VALUES
(1, 'física', NULL),
(2, 'balística', NULL),
(3, 'mental', NULL),
(4, 'sangue', NULL),
...
CREATE TABLE `saude` (
  ...
  `nome_saude` varchar(40) DEFAULT NULL,
  `valor` int(2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `saude` (`id_saude`, `nome_saude`, `valor`) VALUES
(1, 'vida', NULL),
(2, 'sanidade', NULL),
(3, 'esforço', NULL);
...
--
ALTER TABLE `ataques`
  MODIFY `id_ataques` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de tabela `atributos`
--
ALTER TABLE `atributos`
  MODIFY `id_atributos` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `defesas`
  MODIFY `id_defesas` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `resistencias_a_dano`
  MODIFY `id_resistencias` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de tabela `saude`
--
ALTER TABLE `saude`
  MODIFY `id_saude` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
